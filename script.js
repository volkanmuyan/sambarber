...
const i18n = {
  en: {
    ...
    'about.p1': 'Sam started cutting hair at 19 in the backstreets of Molenbeek. What began as a passion became a craft — and a craft became a calling. Today, Sambarber is Brussels\' most trusted grooming destination.',
    ...
    'gallery.fade': 'Precision Fade',
    'gallery.beard': 'Beard Sculpt',
    'gallery.classic': 'Classic Cut',
    'gallery.shave': 'Hot Shave',
    'gallery.texture': 'Textured Top',
    'gallery.line': 'Line Up',
...
bookingForm.addEventListener('submit', e => {
  ...
  if (!(nameOk && phoneOk && serviceOk && dateOk && timeOk)) return;
